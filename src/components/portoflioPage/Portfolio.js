...
const portfolioData = [
  { id: 1, title: "Romeo and Juliet, Dreaming in English, Maid Marian", year: 2024, location: "Set and Costume Designer, White Horse Theatre, Germany", type: "Costume Design", btype: "Set Design",  ctype: "Theatre", src: romeoport},
  { id: 2, title: "Scratch", year: 2024, location: "Short Film - Production and Costume Designer, Dog Sky Films, on location in England", type: "Costume Design", btype: "Set Design",  ctype: "Short Film",src: scratch1},
  { id: 3, title: "Enitans Game", year: 2024, location: "Costume Designer/ Supervisor, PunchDrunk Enrichment, London", type: "Costume", btype: "Theatre" , src: punchdrunk5},
  { id: 4, title: "One Hundred and Eighty", year: 2024, location: "Short Film - Production and Costume Designer, Dark Avenue Film, on location in England", type: "Costume", btype: "Set Design", ctype: "Short Film", src: oneEIghty},
  { id: 5, title: "Twelfth Night", year: 2024, location: "Costume Designer/ Supervisor, London College of Music, London", type: "Costume", btype: "Theatre", src: twelfthNight1_L},
  { id: 6, title: "The Lightning Thief (UK Premier)", year: 2023, location: "Costume Designer/ Supervisor, London College of Music, London", type: "Costume", btype: "Theatre", src: percy6_P },
  { id: 7, title: "Drag Mx Great Britain", year: 2023, location: " Costume Designer/ Maker, Alnwick Castle", type: "Costume", videography: "Events", src: mimiDragMx1_P },
  { id: 8, title: "Latitude and Glastonbury Festivals", year: 2023, location: " Costume Designer/ Maker, Suffolk and Glastonbury", type: "Costume", btype: "Events", src: mimiLat4_P },
  { id: 9, title: "Wild Animal", year: 2023, location: "Short Film - Production and Costume Designer, Backscatter Productions, on location in Wales ",type: "Costume", btype: " Set Design", ctype: "Short Film", src: wildanimalp },
  { id: 10, title: "Sunday in The Park with George", year: 2023, location: "Costume Designer/ Supervisor, London College of Music, London", type: "Costume", btype: "Theatre", src: sundayp },
  { id: 11, title: "5 Years", year: 2023, location: "Set and Costume Designer, Sheffield & UK Tour", type: "Costume”, btype “Theatre Design", ctype: "Theatre", src: fiveYearsStolenJacket },
  { id: 13, title: "Happy Death Day", year: 2022, location: "Short Film - Production Designer, Dog Sky Films, on location in England", type: "Costume", btype: "Set Design", ctype: "Short Film", src: deathport },
  { id: 14, title: "Glastonbury Festival and London Pride", year: 2022, location: "Costume Designer/ Maker, London and Glastonbury", type: "Costume", btype: " Events", src: glastoport },
  { id: 15, title: "Sink The Pink Farewell Ball", year: 2022, location: "Costume Designer/ Maker, Printworks, London ", type: "Costume", btype: "Events", src: sinkport },
  { id: 16, title: "Legally Blonde", year: 2022, location: "Set and Costume Designer, The Urdang Academy, London", type: "Costume ", btype: "Set Design", ctype: "Theatre",  src: legallyport},
  { id: 17, title: "Snow Queen", year: 2021, location: "Costume Designer, Rabble Theatre, Reading", type: "Costume", btype: "Theatre",  src: snowport },
  { id: 18, title: "Immersive 70s Marrakesh", year: 2021, location: "Costume Designer/ Supervisor, Private Client, London", type: "Costume", btype: "Events",  src: morrocoport },
  { id: 19, title: "Immersive Hitchhikers Guide to The Galaxy", year: 2021, location: "Costume Designer/ Supervisor/ Maker, Private Client, Shotgun Carousel, Amsterdam", type: "Costume", btype: "Events",  src: hikersport},
  { id: 20, title: "Fish Wife", year: 2021, location: "Short Film - Production and Costume Designer, on location in Wales", type: "Costume", btype: "Set Design", ctype: "Short Film",  src: fishport },
  { id: 21, title: "Park and Reed", year: 2020, location: " Comedy Tv Series - Proof of Concept - Production Designer, So and So Productions, on location in London", type: " Set Design", btype: "Short Film",  src: parkport },
  { id: 22, title: "Taming of the Shrew", year: 2019, location: " Set and Costume Designer, White Horse Theatre, Germany",type: "Costume Design", btype: "Set Design",  ctype: "Theatre",src: tamingport},
  { id: 23, title: "The Empty Chair and Oliver Twist", year: 2019, location: " Set and Costume Deisgner, White Horse Theatre, Germany",type: "Costume Design", btype: "Set Design",  ctype: "Theatre",src: emptyport},
  { id: 24, title: "Sherlock Holmes and the Invisible Thing", year: 2019, location: "Costume Designer, Rudolf Steiner House, London ", type: " Costume", btype: "Theatre",  src: sherlockport },
  { id: 25, title: "Nice Work If You Can Get It", year: 2018, location: "Set and Costume Designer, Upstairs at The Gatehouse, London", type: " Set Design", btype: "Costume", ctype: "Theatre", src: niceport },
  { id: 26, title: "The Tyrants Kiss", year: 2018, location:"Set and Costume Designer, White Horse Theatre, Germany",type: "Costume Design", btype: "Set Design",  ctype: "Theatre", src: tyrantsport},
  { id: 27, title: "Macbeth", year: 2018, location:"Set and Costume Designer, White Horse Theatre, Germany",type: "Costume Design", btype: "Set Design",  ctype: "Theatre",src: macbethpotfolio},
